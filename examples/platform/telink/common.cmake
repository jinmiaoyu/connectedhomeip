...
if(${TLNK_7218X_ML7G_BOARD} MATCHES y)
  set(ML7G_DTC_OVERLAY_FILE "${CHIP_ROOT}/src/platform/telink/${BOARD}_ml7g.overlay")
  if(NOT EXISTS "${ML7G_DTC_OVERLAY_FILE}")
    message(FATAL_ERROR "${ML7G_DTC_OVERLAY_FILE} doesn't exist")
  endif()
  set(ML7G_CONF_OVERLAY_FILE "${CHIP_ROOT}/src/platform/telink/${BOARD}_ml7g.conf")
  if(NOT EXISTS "${ML7G_CONF_OVERLAY_FILE}")
    message(FATAL_ERROR "${ML7G_CONF_OVERLAY_FILE} doesn't exist")
  endif()
else()
  unset(ML7G_DTC_OVERLAY_FILE)
  unset(ML7G_CONF_OVERLAY_FILE)
endif()
...
if(DTC_OVERLAY_FILE)
  set(DTC_OVERLAY_FILE
    "${DTC_OVERLAY_FILE} ${GLOBAL_DTC_OVERLAY_FILE} ${USB_DTC_OVERLAY_FILE} ${MARS_DTC_OVERLAY_FILE} ${FLASH_DTC_OVERLAY_FILE} ${LOCAL_DTC_OVERLAY_FILE} ${TFLM_OVERLAY_FILE} ${ML7G_DTC_OVERLAY_FILE}"
    CACHE STRING "" FORCE
  )
else()
  set(DTC_OVERLAY_FILE ${GLOBAL_DTC_OVERLAY_FILE} ${USB_DTC_OVERLAY_FILE} ${MARS_DTC_OVERLAY_FILE} ${FLASH_DTC_OVERLAY_FILE} ${LOCAL_DTC_OVERLAY_FILE} ${TFLM_OVERLAY_FILE} ${ML7G_DTC_OVERLAY_FILE})
endif()

if(NOT CONF_FILE)
  set(CONF_FILE ${USB_CONF_OVERLAY_FILE} ${MARS_CONF_OVERLAY_FILE} prj.conf ${TFLM_CONF_OVERLAY_FILE} ${ML7G_CONF_OVERLAY_FILE})
endif()
